...
# Write files
Set-Content -Path "public/favicon.svg" -Value $faviconContent -Encoding UTF8
Set-Content -Path "src/assets/nimbus-logo.svg" -Value $nimbusContent -Encoding UTF8

Write-Host "Logos updated successfully!"
